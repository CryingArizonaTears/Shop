package com.andersenlab.shop.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("@annotation(com.andersenlab.shop.annotation.Logging)")
    public void logging() {
    }
    ...
    @Pointcut("@annotation(com.andersenlab.shop.annotation.LoggingException)")
